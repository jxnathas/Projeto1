...
<head>
	...
	<link rel="icon" href="<?php echo INCLUDE_PATH; ?>favicon.ico" type="image/x-icon" />    <meta charset="utf-8">
...
<body>
    ...
    <header>
        <div class="center">
            <div class="logo left"><a href="<?php echo INCLUDE_PATH ?>"><i class="fa-solid fa-code"></i></a></div> <!-- logo -->
            ...
            <nav class="mobile right">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo INCLUDE_PATH; ?>depoimentos">Depoimentos</a></li>
                    <li><a href="<?php echo INCLUDE_PATH; ?>servicos">Serviços</a></li>
                    <li><a realtime="contato" href="<?php echo INCLUDE_PATH; ?>contato">Contato</a></li>                </ul>
            </nav>
    ...
    <script defer src="<?php echo INCLUDE_PATH; ?>js/maps.js"></script>
